...
symbol="sail"
url = "https://www1.nseindia.com/products/dynaContent/common/productsSymbolMapping.jsp?symbol=" + symbol + "&segmentLink=3&symbolCount=1&series=EQ&dateRange=3month&fromDate=&toDate=&dataType=PRICEVOLUMEDELIVERABLE"

print ("deliverable for : ", url)
# data1 = pd.read_html("./dummy.html")
data1 = pd.read_html(url)
print("Data read")
print(data1)
# data1 = pd.read_html("https://www1.nseindia.com/products/dynaContent/common/productsSymbolMapping.jsp?symbol=sail&segmentLink=3&symbolCount=1&series=EQ&dateRange=3month&fromDate=&toDate=&dataType=PRICEVOLUMEDELIVERABLE")
